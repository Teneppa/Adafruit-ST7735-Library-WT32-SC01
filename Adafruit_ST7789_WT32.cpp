...
// Display dimensions for WT32-SC01
#define DISPLAY_WIDTH 320  ///< Display width in pixels
#define DISPLAY_HEIGHT 480 ///< Display height in pixels
...
*/
Adafruit_ST7789_WT32::Adafruit_ST7789_WT32(int8_t cs, int8_t dc, int8_t mosi, int8_t sclk,
                                           int8_t rst)
...
/*!
    ...
    @param  rst  Reset pin # (optional, pass -1 if unused)
*/
Adafruit_ST7789_WT32::Adafruit_ST7789_WT32(int8_t cs, int8_t dc, int8_t rst)
...
/*!
    ...
    @param  rst       Reset pin # (optional, pass -1 if unused)
*/
Adafruit_ST7789_WT32::Adafruit_ST7789_WT32(SPIClass *spiClass, int8_t cs, int8_t dc,
                                           int8_t rst)
    : Adafruit_ST77xx(DISPLAY_WIDTH, DISPLAY_HEIGHT, spiClass, cs, dc, rst) {}
#endif // end !ESP8266
...
static const uint8_t PROGMEM
  generic_st7789[] =  {                // Init commands for 7789 screens
    ...
    ST77XX_MADCTL , 1,              //  4: Mem access ctrl (directions), 1 arg:
      0b01001010,                         //     Row/col addr, bottom-top refresh
    ST77XX_CASET  , 4,              //  5: Column addr set, 4 args, no delay:
      0x00,
      0,                      //     XSTART = 0
      DISPLAY_WIDTH >> 8,
      DISPLAY_WIDTH & 0xFF,   //     XEND = 240
      ST77XX_RASET  , 4,      //  6: Row addr set, 4 args, no delay:
      0x00,
      0,                      //     YSTART = 0
      DISPLAY_HEIGHT >> 8,
      DISPLAY_HEIGHT & 0xFF,  //     YEND = 320
...
*/
/**************************************************************************/
void Adafruit_ST7789_WT32::init(uint16_t width, uint16_t height, uint8_t mode)
{
...
*/
/**************************************************************************/
void Adafruit_ST7789_WT32::setRotation(uint8_t m)
{
  uint8_t madctl = 0;
